...
function favourateContact(index){console.log("Favourates :",index);if(allContacts[index].favourate){allContacts[index].favourate=!1}else{allContacts[index].favourate=!0}
localStorage.setItem("contacts",JSON.stringify(allContacts));displayContacts();displayFavorates();displayTotalContacts()}
function emergencyContact(index){console.log("Emergency :",index);if(allContacts[index].emergency){allContacts[index].emergency=!1}else{allContacts[index].emergency=!0}
localStorage.setItem("contacts",JSON.stringify(allContacts));displayContacts();displayEmergencies();displayTotalContacts()}
                            ...
                            <div class="item my-bg-white rounded-4 w-100 general-box-shadow general-hover-shadow">
                                ...
                                <div class="item-footer p-3 d-flex align-items-center justify-content-between">
                                    <div class="phone-email d-flex gap-3">
                                        ...
                                        ${allContacts[i].email ? `<div class="bg-hover-indigo-200 rounded-3"><a href="mailto:${allContacts[i].email}" class="btn btn-email my-bg-indigo-200 my-text-indigo-500 rounded-3" title="Email ${allContacts[i].name}"><i class="fa-solid fa-envelope"></i></a></div>` : ""}
                                    </div>
